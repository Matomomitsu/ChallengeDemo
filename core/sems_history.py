...
# Defaults sourced from environment (no hard-coded demo values)
DEFAULT_STATION_ID = os.getenv("DEFAULT_POWERSTATION_ID", "").strip()
DEFAULT_INVERTER_SN = os.getenv("DEFAULT_INVERTER_SN", "").strip()

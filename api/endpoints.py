...
async def google_webhook(request: Request):
    """
    Google Assistant/Dialogflow webhook passthrough to the chat endpoint.
    """
    try:
...
async def delete_scenes_all():
    """
    Delete all scenes in the configured Tuya space (TUYA_CLIENT_ID, TUYA_CLIENT_SECRET, TUYA_SPACE_ID).
    Returns the deleted IDs and the raw Tuya API response.
    """
